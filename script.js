// ------------------ Supabase ------------------
const supabaseUrl = 'https://qdpfntzegmihvcrfltlo.supabase.co';
...
const products = {
    ...
    2: { name: "Bee's Bless", description: "Handmade cherry-scented...", price: 30, images:["images/lipgloss2-1.jpg","images/lipgloss2-2.jpg"] }
};
...
document.getElementById("searchInput").addEventListener("input", function(){
    ...
    document.querySelectorAll(".card").forEach(card=>{
        card.style.display=card.querySelector("h3").textContent.toLowerCase().includes(searchValue)?"block":"none";
    });
});
...
async function showCart(){
    ...
    const cartDiv=document.getElementById('cart-items'); cartDiv.innerHTML=''; let total=0;
...
async function showSaves(){
    ...
    const savesDiv = document.getElementById('saves-items'); savesDiv.innerHTML='';
